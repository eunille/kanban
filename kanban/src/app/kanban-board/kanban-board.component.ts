...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, DragDropModule, KanbanColumnComponent, KanbanCreateTaskFormComponent, KanbanUpdateTaskFormComponent, KanbanTaskCardComponent, ConfirmationModalComponent],
